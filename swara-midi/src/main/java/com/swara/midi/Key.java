 ...
 * thread-safe. Keys are built with a {@link com.swara.midi.Key.Builder}.
 */
public class Key {
    ...
    /**
     * Constructs a {@link com.swara.midi.Key} using a Fluent-style builder pattern. By default, the
     * builder will construct C Major, which is a major key with no sharps nor flats.
     */
